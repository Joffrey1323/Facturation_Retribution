  ...
  <div id="body">
    ...
    function ExportFactureToJSON(){
      ...
      $('#tableau').find("tbody").find("tr").each(function(){
          ...
          var remise= $(this).find('#remise').text();
          produits.push({
            'nom': nomProduit,
            ...
            $.each(data,function(index,d){
              if(d.commande.client.raisonSociale == getParams()){
                ...
                $.each(d.lignes,function(index,l){
                  $('#tableau').append('<tr> <td id="nomProduit">'+l.produit.libelle+'</td> <td id="quantiteProduit">'+ l.quantite+' kg </td> <td id="prixProduit">'+l.produit.prixVente+'€ </td> <td id="quantiteTotalProduit">'+ l.quantite*l.produit.prixVente + '€ </td> <td id="remise"> 10 % </td> </tr>');
